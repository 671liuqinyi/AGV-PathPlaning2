"""
Training entry for MAPPO+MoE2 (3 expert types x 2 experts each).
"""
...
from algorithm.MAPPO_MOE2_structure.Controller import MAPPOMoE2AgentController as modelController
...
def main():
    ...
    print(
        f"MAPPO+MoE2 train config: layout_mode={LAYOUT_MODE}, layout={layout.scene_x_width}x{layout.scene_y_width}, "
        f"agv={explorer_num}, task_num_limit={task_num_limit}, max_steps={multi_agv_scene.max_training_steps}"
    )
    print(f"MAPPO+MoE2 curriculum stages: {curriculum_stages}")
