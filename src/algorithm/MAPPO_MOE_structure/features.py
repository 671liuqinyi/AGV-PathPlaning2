...
def extract_expert_features(all_info, this_veh, valid_path_matrix, map_xdim, map_ydim):
    """
    Build handcrafted features that guide MoE experts:
    - straight dash expert: target direction and distance.
    - obstacle expert: local free/blocked pattern.
    - yielding expert: nearby vehicle occupancy/conflict risk.
    """
    current_place = None
    target_place = None
    other_positions = []
